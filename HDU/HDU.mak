...
ifndef include_dir
include_dir = C:\Developpement\MinGW\include
endif
...
ifndef libdir
libdir = C:\Developpement\MinGW\lib
endif
...
CFLAGS+=-W -fexceptions -O2 $(INCLUDES) -DWIN32 -DNDEBUG
AR=ar
ARFLAGS=rus
else

ifeq "$(CFG)"  "HDU_DEBUG"
CFLAGS+=-Wall -fexceptions -g -O0 $(INCLUDES) -DWIN32 -D_DEBUG
AR=ar
TARGET=HDUD
ARFLAGS=rus
endif
